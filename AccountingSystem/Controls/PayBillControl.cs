...
namespace AccountingSystem.Controls
{
    public partial class PayBillControl : UserControl
    {
        ...
        void InitBalanceAccountGrid() {
            ...
            gridBalanceAccounts.Columns["Description"].HeaderText = "Diễn giải";
            gridBalanceAccounts.Columns["Amount"].HeaderText = "Tiền";
        }
        ...
        void LoadInvoices() {
            ...
            gridInvoices.Columns["Code"].HeaderText = "Số hóa đơn";
            ...
            gridInvoices.Columns["DateTax"].HeaderText = "Ngày hóa đơn";
            ...
            gridInvoices.Columns["Tax"].HeaderText = "T.Suất";
            ...
            gridInvoices.Columns["CustomerId"].HeaderText = "MS khách hàng";
            ...
            gridInvoices.Columns["CustomerName"].HeaderText = "Tên khách hàng";
            ...
            gridInvoices.Columns["CustomerAccountNo"].HeaderText = "Tài khoản NH";
            ...
            gridInvoices.Columns["AmountNotTax"].HeaderText = "Tiền chưa thuế";
            ...
            gridInvoices.Columns["AmountHasTax"].HeaderText = "Tiền thuế";
            ...
            gridInvoices.Columns["Note"].HeaderText = "Ghi chú";
        }
